...
TESTCASES_JOSEFSSON = {
  ...
  "D" => [
    [0x0050, 0x0072, 0x006F, 0x010D, 0x0070, 0x0072, 0x006F, 0x0073,
     ...
     0x00ED, 0x010D, 0x0065, 0x0073, 0x006B, 0x0079].map(&.chr).join,
  ...
  "E" => [
    [0x05DC, 0x05DE, 0x05D4, 0x05D4, 0x05DD, 0x05E4, 0x05E9, 0x05D5,
     ...
     0x05DD, 0x05E2, 0x05D1, 0x05E8, 0x05D9, 0x05EA].map(&.chr).join,
  ...
  "F" => [
    [0x092F, 0x0939, 0x0932, 0x094B, 0x0917, 0x0939, 0x093F, 0x0928,
     ...
     0x0915, 0x0924, 0x0947, 0x0939, 0x0948, 0x0902].map(&.chr).join,
  ...
  "H" => [
    [0x043F, 0x043E, 0x0447, 0x0435, 0x043C, 0x0443, 0x0436, 0x0435,
     ...
     0x0441, 0x0441, 0x043A, 0x0438].map(&.chr).join,
  ...
  "J" => [
    [0x0054, 0x1EA1, 0x0069, 0x0073, 0x0061, 0x006F, 0x0068, 0x1ECD,
     ...
     0x1EBF, 0x006E, 0x0067, 0x0056, 0x0069, 0x1EC7, 0x0074].map(&.chr).join,
  ...
  "O" => [
    [0x004D, 0x0061, 0x006A, 0x0069, 0x3067, 0x004B, 0x006F, 0x0069,
     0x3059, 0x308B, 0x0035, 0x79D2, 0x524D].map(&.chr).join,
  ...
  "Q" => [
    [0x305D, 0x306E, 0x30B9, 0x30D4, 0x30FC, 0x30C9, 0x3067].map(&.chr).join,
    "xn--d9juau41awczczp",
  ] of String | Bool,
  ...
  "S" => [
    [0x0062, 0x006F, 0x006E, 0x0121, 0x0075, 0x0073, 0x0061, 0x0127,
     0x0127, 0x0061].map(&.chr).join,
    "xn--bonusaa-5bb1da",
  ] of String | Bool,
} of String => Array(String | Bool)
